...
$sql = "SELECT ProductID, ProductName, Price, ImagePath FROM product WHERE Category = 'Fruits and Vegetables'";
...
<head>
    <meta charset="UTF-8">
    <title>Cloverse - Fruits & Vegetables</title>
...
<body>
    ...
    <section>
        <h1 class="heading" style="margin-top: 150px;">Collection <span>Fruits & Vegetables</span></h1>
